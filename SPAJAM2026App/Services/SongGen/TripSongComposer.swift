...
enum TripSongMood: String, CaseIterable, Identifiable {
    ...
    var lyricsTone: String {
        switch self {
        case .high: "ミッション達成を、人類史に残る偉業かのように大げさに喜びすぎるトーン。感動の押し売りで笑えるくらいオーバーに"
        case .low: "ミッションを全然達成できなかったことに怒りすぎるトーン。コミカルにキレ散らかす。本気の説教ではなく、誇張しすぎて笑えるやつ"
        }
    }
...
final class TripSongComposer {
    ...
    private static func generateLyrics(
        ...
        - 達成/未達成のミッション名(地名・食べ物など)を具体的に 2 つ以上挙げて、それをネタにする
        - 「スマホを見ない旅」がテーマ。まじめに歌わず、大げさで笑える歌詞にする
